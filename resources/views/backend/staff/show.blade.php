  ...
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6 pl-1">
        <label for="student_id" class="control-label">Staff Name</label>
                    ...
                    <table class="table table-bordered table-hover table-sm">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          {{-- {{$data->client_id}}
                           <a href="" class="btn btn-xs btn-outline-info" data-placement="top" title="View Detail"><i class="fas fa-eye"></i>
                           </a> --}}
                           <a href="{{ route('admin.client.show',$data->client_id) }}" class="btn btn-xs btn-outline-info" data-placement="top" title="View Detail"><i class="fas fa-eye"></i>
                           </a>
                        </td>
                      </tr>
                      @endforeach
