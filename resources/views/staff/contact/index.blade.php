...
<section class="content">
  <div class="card">
    <div class="card-header">
      {{-- <a href="{{route('staff.contact.create')}}" class="btn btn-sm btn-info text-capitalize rounded-0">Add Contact</a> --}}
      ...
      <table class="table table-bordered table-hover my-0 table-sm">
        ...
        <tr class="text-center">
          ...
          <td>
            ...
            <form action="{{ route('staff.contact.destroy',$data->id) }}" method="post" class="d-inline-block delete-confirm" data-placement="top" title="Permanent Delete">
              {{method_field('delete')}}
              {{ csrf_field() }}
